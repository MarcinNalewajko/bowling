...
def x_in_frame1_9(throw_list, score, i):
    score.append(10)
    try:
...
def throw1_in_frame1_9(throw_list, score, i):
    if throw_list[i][0] == '-':
        score.append(0)
    else:
...
def throw2_in_frame1_9(throw_list, score, i):
    if throw_list[i][1] == '-':
        score[i] += 0
    elif throw_list[i][1] == '/':
        try:
...
def frames1_9(throw_list, score):
    for i in range(0, 9):
        if throw_list[i] == 'x':
            x_in_frame1_9(throw_list, score, i)
        else:
            throw1_in_frame1_9(throw_list, score, i)
            throw2_in_frame1_9(throw_list, score, i)
    return score


def x_in_frame10(throw_list, score):
    score.append(10)
    if throw_list[8] == 'x':
        score[8] += 10
        if throw_list[7] == 'x':
...
def throw1_in_frame10(throw_list, score):
    if throw_list[9][0] == '-':
        score.append(0)
    else:
...
def throw2_and3_in_frame10(throw_list, score):
    if throw_list[9][1] == '/':
        score[9] = 10
        if throw_list[8][0] == 'x':
...
def frame10(throw_list, score):
    if throw_list[9][0] == 'x':
        x_in_frame10(throw_list, score)
    else:
        throw1_in_frame10(throw_list, score)
        throw2_and3_in_frame10(throw_list, score)
    return score
